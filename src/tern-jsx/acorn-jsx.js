...
module.exports.inject = function (acorn, injectable) {
  if (!injectable) {
    injectable = acorn;
    acorn = require('acorn');
  }
  ...
  const toInject = function (instance, opts) {
    if (!opts) {
      return;
    }
    ...
    instance.options.plugins.jsx = {
      ...
      allowNamespacedObjects: Boolean(opts.allowNamespacedObjects),
    };

    instance.extend('parseExprAtom', function (inner) {
      return function (refShortHandDefaultPos) {
        if (this.type === tt.jsxText) return this.jsx_parseText(this.value);
        if (this.type === tt.jsxTagStart) return this.jsx_parseElement();
